...
func setupOTelSDK(ctx context.Context, res *resource.Resource, conn *grpc.ClientConn) (func(context.Context) error, error) {
	...
	// For traces in instance, Shutdown will flush any remaining spans and
